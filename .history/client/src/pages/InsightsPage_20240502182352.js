...
const drawElements = [
    ...
    },
    {
        ...
        route: `http://${config.server_host}:${config.server_port}/get_insight_retirement`,
        columns: [
            {
                field: 'Tract',
                headerName: 'Tract ID',
            ...
            },
            {
                ...
                renderCell: (row) => <div>{row.Listing}</div>
            },
            {
                field: 'Price',
                headerName: 'Price',
    ...
    },
    {
        id: 4,
        text: 'Walkability',
        description: 'Most Walkable',
        route: `http://${config.server_host}:${config.server_port}/get_insight_walkability`,
        columns: [
            {
                field: 'City',
                headerName: 'City',
